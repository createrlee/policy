...
Chewon Lee built the NFT Platz app as a Free app. This SERVICE is provided by Chewon Lee at no cost and is intended for use as is.
...
1. 개인정보의 처리 목적 (‘NFT Platz’ 이하 ‘Platz’) 은(는) 다음의 목적을 위하여 개인정보를 처리하고 있으며, 다음의 목적 이외의 용도로는 이용하지 않습니다.
